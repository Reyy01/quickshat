...
// in quickchat_ui/test/features/authentication/data/datasources/auth_remote_datasource_test.dart.
...
import 'package:quickchat_ui/config.dart' as _i10;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockConfig extends _i1.Mock implements _i10.Config {
  MockConfig() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String get quickChatService => (super.noSuchMethod(
        Invocation.getter(#quickChatService),
  ...
  @override
  String get quickChatSSEService => (super.noSuchMethod(
        Invocation.getter(#quickChatSSEService),
        returnValue: _i11.dummyValue<String>(
          this,
          Invocation.getter(#quickChatSSEService),
        ),
