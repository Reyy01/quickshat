...
final Map<String, List<dynamic>> theme = <String, List<dynamic>>{
  ...
  'buttonTheme': <dynamic>[
    const ButtonThemeData(
      colorScheme: ColorScheme.dark(surface: CustomColor.instagramYellow),
    ),
    const ButtonThemeData(
      colorScheme: ColorScheme.dark(surface: CustomColor.instagramDarkBlue),
    ),
  ],
  'radioTheme': <dynamic>[
    RadioThemeData(
      fillColor: WidgetStateProperty.all<Color>(CustomColor.instagramDarkBlue),
    ),
    RadioThemeData(
      fillColor: WidgetStateProperty.all<Color>(CustomColor.instagramYellow),
    ),
  ],
